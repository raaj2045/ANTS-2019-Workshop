...
class HDWalletProvider {
    constructor(mnemonic, provider, addressIndex = 0, numAddresses = 1, shareNonce = true, walletHdpath = `m/44'/60'/0'/0/`) {
        ...
        if (typeof provider === "string") {
            ...
            this.engine.addProvider(new provider_1.default(
            // @ts-ignore
            new web3_1.default.providers.HttpProvider(provider, { keepAlive: false })));
        }
        else {
